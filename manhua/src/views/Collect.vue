  ...
  <div class="bookshelf">
    <van-tabs ref="cole" :swipeable="true" swipe-threshold="10" animated>
      <van-tab class="nav" title="收藏">
        <div class="body f-flex1" v-show="collectBooks.length!==0">
          <div class="book f-flex2" v-for="(book,index) in collectBooks" @click="watchP(book.comic_id)" :key="index">
        ...
        <div class="sorry f-flex2" v-show="collectBooks.length===0">
          <img src="../assets/img/unsearch.png" alt="">
          书架空空的，去首页看看吧
        </div>
      </van-tab>
      <van-tab class="nav" title="历史">
        <div class="body2" v-show="historyBooks.length!==0">
          <div class="book2 f-flex1" v-for="(book,index) in historyBooks" @click="watchP(book.comic_id)" :key="index">
            <img v-lazy="'http://image.yqmh.com/mh/'+book.comic_id+'.jpg-600x800.jpg.webp'" alt="">
        ...
        <div class="sorry f-flex2" v-show="historyBooks.length===0">
          <img src="../assets/img/unsearch.png" alt="">
          还没有阅读记录
        </div>
      </van-tab>
